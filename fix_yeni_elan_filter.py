...
text = text.replace("Elanınız uğurla əlavə edildi!", "Elanınız yoxlanışdadır (GÖZLƏMƏDƏ)!")
text = text.replace("Yeni elanınız artıq yoxlanışa göndərildi və qısa zamanda saytda görünəcək. Daha çox alıcı tapmaq üçün elanınızı önə çəkə bilərsiniz.", "Elanınız avtomatik yoxlanışdan keçir (1 dəqiqə ərzində aktiv olacaq). Elanlar siyahısında izləyə bilərsiniz.")
